  ...
  components: {
    ...
    schemas: {
      ...
      AssemblyPoint: {
        type: 'object',
        nullable: true,
        description: 'Olay başına TEK toplanma noktası; nokta değişirse sunucu otomatik bildirir.',
        properties: {
          id: { type: 'string' },
          name: { type: 'string' },
        ...
        allOf: [
          { $ref: '#/components/schemas/ActiveMissionSummary' },
          {
            ...
            properties: {
              ...
              stats: {
                type: 'object',
                description: 'Sahadaki gönüllü sayısının tek kaynağı check-in kaydıdır.',
                properties: { volunteers: { type: 'integer' } },
              },
              checkInTrend: {
                type: 'object',
                properties: { windowMinutes: { type: 'integer', example: 15 }, count: { type: 'integer' } },
              },
              ...
              assemblyPoint: { $ref: '#/components/schemas/AssemblyPoint' },
              qrPayload: { type: 'string', nullable: true, example: 'OGM:VOL:8f3c...' },
            },
          },
        ],
      },
      FireMissionSummary: {
        type: 'object',
        description: 'Görev Aldığım Yangınlar — yalnızca userStatus yolda | sahada | tamamladi olan olaylar.',
        properties: {
          id: { type: 'string' },
          title: { type: 'string' },
          ...
          startDate: {
            ...
            format: 'date',
            nullable: true,
            description: 'start_date yoksa olayın başladığı an (started_at) kullanılır',
          },
          endDate: { type: 'string', format: 'date', nullable: true },
          status: { type: 'string', enum: ['active', 'archived'] },
          userStatus: { type: 'string', enum: ['yolda', 'sahada', 'tamamladi'] },
      ...
      OnlineTraining: {
        ...
        properties: {
          ...
          startsAt: {
            ...
            format: 'date-time',
            nullable: true,
            description: 'Yüz yüze oturumun başlangıcı — delivery=online ise her zaman null',
          },
      ...
      SahaTraining: {
        ...
        properties: {
          ...
          cover: { type: 'string', format: 'uri', nullable: true },
          grantsCompetency: { type: 'boolean' },
          enrolled: { type: 'integer' },
          attended: { type: 'integer' },
          availableSeats: {
            type: 'integer',
            description: 'K4: kontenjan kesin sınırdır — 0 ise başvuru 410 training_full alır',
          },
      ...
      FireReportSummary: {
        ...
        properties: {
          ...
          title: {
            type: 'string',
            nullable: true,
            example: '[48700] Muğla, Marmaris 001',
            description: 'Posta kodu + il/ilçeden türer; açık adres gösterilmez',
          },
          postalCode: { type: 'string', nullable: true },
          il: { type: 'string', nullable: true },
          ilce: { type: 'string', nullable: true },
          locationName: { type: 'string' },
          regionLabel: { type: 'string' },
          region: { type: 'string', nullable: true, example: 'ege' },
          regionName: { type: 'string', nullable: true, example: 'Ege' },
          status: { type: 'string', enum: ['reviewing', 'confirmed', 'rejected'] },
          statusLabel: { type: 'string', enum: ['İnceleniyor', 'Doğrulandı', 'Reddedildi'] },
          ...
          missionId: {
            type: 'string',
            nullable: true,
            description: 'İhbarın bağlandığı olay (bağlıysa) — görev detayına geçiş için',
          },
        },
      },
      Readiness: {
        ...
        properties: {
            ...
            properties: {
              steps: {
                ...
                items: {
                  type: 'object',
                  properties: {
                    key: { type: 'string', enum: ['komisyon', 'teorik', 'uygulamali', 'kkd'] },
                    label: { type: 'string' },
                    done: { type: 'boolean' },
              ...
              komisyon: { type: 'string', example: 'approved' },
              eksikAdimlar: { type: 'array', items: { type: 'string' } },
              siradakiAdim: { type: 'string', nullable: true },
              kkdDurumu: { type: 'string' },
              tamam: { type: 'boolean' },
            },
          },
          kisiDurumu: { type: 'string', enum: ['basvuru', 'hazir', 'pasif'] },
          mudahaleYetkisi: { type: 'boolean' },
          engeller: {
            type: 'array',
          ...
          komisyon: {
            type: 'object',
            properties: {
              decision: { type: 'string', example: 'pending' },
